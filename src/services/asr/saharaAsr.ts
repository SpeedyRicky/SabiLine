...
/**
 * Real HTTP integration for Intron Sahara's ASR endpoint, mirroring the
 * request pattern this codebase's existing Sahara TTS call already uses
 * (https://api.intron.io/v1/tts/synthesize) for consistency.
 *
